...
public class Arith {
    ...
    public static double round(double v, int scale) {
        ...
        return BigDecimal.valueOf(v).divide(new BigDecimal("1"), scale, BigDecimal.ROUND_HALF_UP).doubleValue();
    }
    ...
    public static double returnMax(double v1, double v2) {
        return BigDecimal.valueOf(v1).max(BigDecimal.valueOf(v2)).doubleValue();
    }
    ...
    public static double returnMin(double v1, double v2) {
        return BigDecimal.valueOf(v1).min(BigDecimal.valueOf(v2)).doubleValue();
    }
