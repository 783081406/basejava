...
public class SimpleDateFormatTest {
    ...
    private static void testPattern() {
        ...
        SimpleDateFormat myFmt4 = new SimpleDateFormat("一年中的第D天,一年中第w个星期,一月中第W个星期," +
                "在一天中k时,z时区");
        Date now = new Date();
        System.out.println(myFmt.format(now));//2017年03月09日 19时51分32秒
        System.out.println(myFmt1.format(now));//17/03/09 19:51
        System.out.println(myFmt2.format(now));//2017-03-09 19:51:32
        System.out.println(myFmt3.format(now));//2017年03月09日 19时51分32秒 星期四
        System.out.println(myFmt4.format(now));//一年中的第68天,一年中第10个星期,一月中第2个星期,在一天中19时,CST时区
        System.out.println(now.toString());//Thu Mar 09 19:51:32 CST 2017
    }
