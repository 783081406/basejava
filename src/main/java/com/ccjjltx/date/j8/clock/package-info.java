 ...
 * int hashCode():
 * abstract Instant instant():得到当前clock的current
 * long millis():得到当前clock的millisecond的instant
 * static Clock offset(Clock baseClock,Duration offsetDuration):获得clock返回instants来自指定始终和指定增加的持续时间
 ...
 * static Clock tick(Clock baseClock,Duration tickDuration):得到一个clock
