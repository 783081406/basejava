...
public class AttributeViewTest {
    public static void main(String[] args) throws Exception {
        //获取将要操作的文件
        Path testPath = Paths.get("src/main/java/com/ccjjltx/io/nio2/attribute/test.txt");
        ...
        //获取系统中guest对应的用户
        UserPrincipal user = FileSystems.getDefault().getUserPrincipalLookupService().lookupPrincipalByName("DESKTOP-5GF8712\\ccjjltx");
        //修改用户
        ...
        //添加一个自定义属性
        userView.write("发行者", Charset.defaultCharset().encode("DESKTOP-5GF8712\\ccjjltx"));
